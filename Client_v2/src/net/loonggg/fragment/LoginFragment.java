...
public class LoginFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		left=(ImageView)view.findViewById(R.id.iv_home_left);
	 ...
	 * // and hide the relevant UI components. mProgressView.setVisibility(show
	 * ? View.VISIBLE : View.GONE); mLoginFormView.setVisibility(show ?
